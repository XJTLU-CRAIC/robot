...
if("TRUE" STREQUAL "TRUE")
  set(clear_costmap_recovery_SOURCE_PREFIX /root/workspace/sebot-t710-competition/sebot_ros_kits/src/sebot_navigation/clear_costmap_recovery)
  set(clear_costmap_recovery_DEVEL_PREFIX /root/workspace/sebot-t710-competition/sebot_ros_kits/devel)
  ...
  set(clear_costmap_recovery_INSTALL_PREFIX /root/workspace/sebot-t710-competition/sebot_ros_kits/install)
...
if(NOT "/root/workspace/sebot-t710-competition/sebot_ros_kits/src/sebot_navigation/clear_costmap_recovery/include " STREQUAL " ")
  set(clear_costmap_recovery_INCLUDE_DIRS "")
  set(_include_dirs "/root/workspace/sebot-t710-competition/sebot_ros_kits/src/sebot_navigation/clear_costmap_recovery/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'clear_costmap_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/workspace/sebot-t710-competition/sebot_ros_kits/src/sebot_navigation/clear_costmap_recovery/${idir}'.  ${_report}")
    endif()
