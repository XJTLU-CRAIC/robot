...
#include "../../../src/sebot_marking/include/qnode.hpp"
...
QT_MOC_LITERAL(1, 6, 18), // "sendMultiNaviGaols"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "QNode\0sendMultiNaviGaols\0"
};
...
void QNode::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendMultiNaviGaols(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNode::sendMultiNaviGaols)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QNode::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_QNode.data,
      qt_meta_data_QNode,  qt_static_metacall, nullptr, nullptr}
};
