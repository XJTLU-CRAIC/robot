...
namespace stdr_gui
{
  ...
  **/
  ...
  @return void
  **/
  CGuiController::CGuiController(int argc, char **argv) : gui_connector_(argc, argv),
                                                          ...
                                                          argv_(argv)
  {
    ...
    icon_move_.addFile(QString::fromUtf8((
                                             ...
                                             std::string("/resources/images/arrow_move.png"))
                                             .c_str()),
                       QSize(20, 20), QIcon::Normal, QIcon::Off);

    icon_delete_.addFile(QString::fromUtf8((
                                               stdr_gui_tools::getRosPackagePath("stdr_gui") +
                                               std::string("/resources/images/remove_icon.png"))
                                               .c_str()),
                         QSize(20, 20), QIcon::Normal, QIcon::Off);
  }
  ...
  void CGuiController::setupWidgets(void)
  {
    ...
    }
    {
      initial_map_ = running_map_ = QImage((
                                               stdr_gui_tools::getRosPackagePath("stdr_gui") +
                                               std::string("/resources/images/logo.png"))
                                               .c_str());
  ...
  **/
  void CGuiController::receiveThermalSources(const stdr_msgs::ThermalSourceVector &msg)
  {
  ...
  **/
  void CGuiController::receiveSoundSources(const stdr_msgs::SoundSourceVector &msg)
  {
         ...
         it++)
    {
      ...
      else
      {
        ...
        for (unsigned int r = 0; r < registered_robots_.size(); r++)
        {
          ...
          {
            it->second->setImage(
                registered_robots_[r].getVisualization(map_msg_.info.resolution));
    ...
    for (unsigned int i = 0; i < all_robots_.robots.size(); i++)
    {
      if (all_robots_.robots[i].name == robotName.toStdString())
      {
        for (unsigned int j = 0;
             ...
             j++)
        {
          if (all_robots_.robots[i].robot.laserSensors[j].frame_id == laserName.toStdString())
          {
    ...
    for (unsigned int i = 0; i < all_robots_.robots.size(); i++)
    {
      if (all_robots_.robots[i].name == robotName.toStdString())
      {
        for (unsigned int j = 0;
             ...
             j++)
        {
          if (all_robots_.robots[i].robot.sonarSensors[j].frame_id == sonarName.toStdString())
          {
  ...
  **/
  ...
  signal
  **/
  void CGuiController::rfidReaderVisibilityClicked(QString robotName, QString rfidReaderName)
  {
    for (unsigned int i = 0; i < registered_robots_.size(); i++)
    {
      if (registered_robots_[i].getFrameId() == robotName.toStdString())
  ...
  signal
  **/
  void CGuiController::co2SensorVisibilityClicked(QString robotName, QString co2SensorName)
  {
    for (unsigned int i = 0; i < registered_robots_.size(); i++)
    {
      if (registered_robots_[i].getFrameId() == robotName.toStdString())
  ...
  signal
  **/
  void CGuiController::thermalSensorVisibilityClicked(QString robotName, QString thermalSensorName)
  {
    for (unsigned int i = 0; i < registered_robots_.size(); i++)
    {
      if (registered_robots_[i].getFrameId() == robotName.toStdString())
  ...
  signal
  **/
  void CGuiController::soundSensorVisibilityClicked(QString robotName, QString soundSensorName)
  {
    for (unsigned int i = 0; i < registered_robots_.size(); i++)
    {
      if (registered_robots_[i].getFrameId() == robotName.toStdString())
