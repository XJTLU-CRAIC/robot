...
namespace stdr_gui
{
  ...
  **/
  CGuiThermal::CGuiThermal(stdr_msgs::ThermalSensorMsg msg, std::string baseTopic) : msg_(msg)
  {
    topic_ = msg_.frame_id;
  ...
  **/
      ...
      tf::TransformListener *listener)
  {
    ...
    painter.drawPie(
        ...
        -(pose_theta - msg_.angleSpan / 2.0) * 180.0 / STDR_PI * 16,
